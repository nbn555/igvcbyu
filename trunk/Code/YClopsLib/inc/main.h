 ...
 * \li baseMrptProject - a template project which has all the dependencies for compiling against YClopsLib
 * \li MapCreator - utility to create maps to test in the simulator
 * \li Simulator - a simulator for the yclops robot used to test the current version of the AI sub system.
 * \li YClopsLib - The shared library project with all the code.
 */
